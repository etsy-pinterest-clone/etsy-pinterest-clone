    ...
    const submitPost = (e) => {
        ...
        axios.post('/user/store/createitem', data1)
            .then(res => {
                ...
                props.newItem({ date: res.data.date, category: res.data.category, title: res.data.title, description: res.data.description, price: res.data.price, media: res.data.media })
